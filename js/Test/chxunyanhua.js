                    ...
                    return pool.request()
                        ...
                        .then(result => {
                            ...
                            if (result.recordset && result.recordset.length > 0) {
                                ...
                                console.log("--------------你好-----------------");
                                console.log(result.recordset.map(function(item){
                                        return formatDateTimeTo12Hour(item.Time);
                                    })
                                );
                                console.log(result.recordset.map(function(item){
                                ...
                                //console.log(JSON.stringify(result.recordset, replacer, 2));
